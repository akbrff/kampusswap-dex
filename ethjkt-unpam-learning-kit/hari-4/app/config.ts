...
export const CONFIG = {
  ...
  AMM_ADDRESS: "0xa97918aEA215D312f3BE9159D99f4d056952BFFF" as Address,

  // TOKEN A = KOIN KAMU (harus SAMA dengan tokenA di SimpleAMM).
  TOKEN_A: {
    address: "0xEf2ba1272Ac365b744d4eaa7BeF27B56DEC964a9" as Address,
    logo: "/FFT.jpeg", // ganti dengan logo koinmu (file di public/)
  },

  // TOKEN B = ETHJKT (token bersama dari pengajar).
  TOKEN_B: {
    address: "0x7E96fed902B0A26b62DA78e8112253920Fc55936" as Address,
